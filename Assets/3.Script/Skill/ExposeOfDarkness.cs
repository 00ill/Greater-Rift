...
public class ExposeOfDarkness : MonoBehaviour
{
    private PlayerStatus _playerStatus;
    private readonly WaitForSeconds _playTime = new(3f);
    ...
    private IEnumerator AttackEnemy()
    {
        while (true)
        {
            ...
            {
                _targetEnemy[i].TakeDamage((int)(_playerStatus.GetStats(Statistic.Damage).IntetgerValue * Managers.Skill.GetSkillData(SkillName.ExposeOfDarkness).DamageCoefficient), _playerStatus);
            }
