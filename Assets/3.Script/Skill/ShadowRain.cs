...
public class ShadowRain : MonoBehaviour
{
    private PlayerStatus _playerStatus;
    private readonly WaitForSeconds _playTime = new(10f);
    ...
    private IEnumerator AttackEnemy()
    {
        while (true)
        {
            ...
            {
                _targetEnemy[i].TakeDamage((int)(_playerStatus.GetStats(Statistic.Damage).IntetgerValue * Managers.Skill.GetSkillData(SkillName.ShadowRain).DamageCoefficient), _playerStatus);
            }
